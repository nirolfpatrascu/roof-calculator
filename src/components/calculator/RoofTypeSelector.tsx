...
export default function RoofTypeSelector({ selected, onSelect }: RoofTypeSelectorProps) {
  return (
    <select
      ...
      className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-base bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition"
    >
